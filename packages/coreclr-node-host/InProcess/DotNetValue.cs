namespace CoreclrNodeHost.InProcess
{
    ...
    public struct DotNetValue
    {
        ...
        public IntPtr Value;
        internal ReleaseDotNetValue ReleaseFunc;

        internal static DotNetValue FromObject(object obj, IHostInProcess host)
        {
            if (null == obj)
                return NullValue;
        ...
        internal static DotNetValue FromDelegate(Delegate @delegate, IHostInProcess host)
        {
            var value = host.MarshallCallback(InvokeHelper.CreateInvoker(@delegate, host), out var releaseCallback);

            return new DotNetValue { Type = DotNetType.Function, Value = value, ReleaseFunc = releaseCallback };
        }
        ...
        public static DotNetValue FromJsValue(JsValue value)
        {
            ...
            return new DotNetValue { Type = DotNetType.JsHandle, Value = ptr, ReleaseFunc = ReleaseHGlobal };
        }

        public static DotNetValue FromString(string value)
        {
            return new DotNetValue { Type = DotNetType.String, Value = NativeUtf8FromString(value), ReleaseFunc = ReleaseString };
        }

        public static DotNetValue FromBool(bool value)
        {
            return new DotNetValue { Type = DotNetType.Boolean, Value = value ? new IntPtr(1) : IntPtr.Zero, ReleaseFunc = null };
        }

        public static DotNetValue FromInt(int value)
        {
            return new DotNetValue { Type = DotNetType.Int32, Value = new IntPtr(value), ReleaseFunc = null };
        }
        ...
        {
            return new DotNetValue { Type = DotNetType.ByteArray, Value = ArrayPointer(value), ReleaseFunc = ReleaseArrayPointer };
        }
        ...
        public static DotNetValue FromNativeMemory(NativeMemory.Handle value)
        {
            ...
            return new DotNetValue { Type = DotNetType.ByteArray, Value = structPtr, ReleaseFunc = ReleaseNativeMemory };
        }

        private static DotNetValue FromReadOnlyCollection(IReadOnlyCollection<object> collection, IHostInProcess host)
        {
            return new DotNetValue { Type = DotNetType.Collection, Value = CollectionPointer(collection, host), ReleaseFunc = ReleaseHGlobal };
        }

        public static DotNetValue FromException(Exception value)
        {
            return new DotNetValue { Type = DotNetType.Exception, Value = NativeUtf8FromString($"{value.GetType().Name}: {value.Message}\n{value.StackTrace}"), ReleaseFunc = ReleaseString };
        }

        internal static DotNetValue FromTask(Task value, IHostInProcess host)
        {
            return new DotNetValue { Type = DotNetType.Task, Value = host.MarshallTask(value), ReleaseFunc = null };
        }
        ...
        public static readonly DotNetValue NullValue = new DotNetValue { Type = DotNetType.Null, Value = IntPtr.Zero, ReleaseFunc = null };
